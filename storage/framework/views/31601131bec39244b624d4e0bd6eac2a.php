<div class="min-h-screen bg-gradient-to-br from-white to-gray-50 px-8 py-6">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notification): ?>
        <div 
            ...
            :class="<?php echo json_encode($notificationType, 15, 512) ?> === 'success' ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'"
            class="max-w-7xl mx-auto mb-6 border rounded-lg p-4 flex items-start gap-3"
        >
            <div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($notificationType === 'success'): ?>
            ...
            <p :class="<?php echo json_encode($notificationType, 15, 512) ?> === 'success' ? 'text-green-800' : 'text-red-800'">
    ...
    <div class="max-w-7xl mx-auto mb-6 bg-white rounded-lg shadow-md p-4 md:p-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($searchTerm) || !empty($filterStatus) || !empty($filterProvince)): ?>
            <button 
    ...
    <div class="max-w-7xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($communities->count() > 0): ?>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $communities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $community): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 text-sm text-gray-900 font-medium"><?php echo e($community->name); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($community->municipality); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($community->province); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($community->contact_person): ?>
                                        <div><?php echo e($community->contact_person); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($community->contact_number): ?>
                                        <div class="text-xs text-gray-500"><?php echo e($community->contact_number); ?></div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="px-6 py-4 text-sm">
                                    <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($community->status_badge); ?>" style="background-color: <?php echo e($community->status === 'active' ? '#d1fae5' : '#f3f4f6'); ?>; color: <?php echo e($community->status === 'active' ? '#047857' : '#374151'); ?>;">
                                        <?php echo e($community->status_label); ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        <button 
                                            wire:click="viewAssessmentSummary(<?php echo e($community->id); ?>)"
                                            class="<?php if($community->assessmentSummary): ?> text-green-600 hover:text-green-800 <?php else: ?> text-gray-400 cursor-not-allowed <?php endif; ?> font-medium text-sm" 
                                            title="<?php if($community->assessmentSummary): ?> View Assessment Summary <?php else: ?> No assessment summaries available <?php endif; ?>"
                                            <?php if(!$community->assessmentSummary): ?> disabled <?php endif; ?>
                                        >
                                        ...
                                        <button 
                                            wire:click="editCommunity(<?php echo e($community->id); ?>)"
                                        ...
                                        <button 
                                            wire:click="confirmDelete(<?php echo e($community->id); ?>)"
            ...
            <div class="px-6 py-4 border-t border-gray-200">
                <?php echo e($communities->links(data: ['scrollTo' => false])); ?>
                ...
                <div class="bg-gradient-to-r from-blue-900 to-blue-800 text-white p-6 border-b-4 border-yellow-500 flex-shrink-0">
                    <div class="flex justify-between items-center">
                        <h2 class="text-2xl font-bold">
                            <?php echo e($editingId ? 'Edit Community' : 'Add New Community'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                            >
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['municipality'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end gap-3">
                    ...
                    >
                        <?php echo e($editingId ? 'Update Community' : 'Create Community'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showDeleteModal && $deleteId): ?>
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showAssessmentModal && $viewingCommunity && $viewingCommunity->assessmentSummary): ?>
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div class="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col">
                <!-- Modal Header -->
                <div class="bg-gradient-to-r from-blue-900 to-blue-800 px-6 py-4 rounded-t-lg flex justify-between items-center">
                    <h2 class="text-xl font-bold text-white">Assessment Summary - <?php echo e($viewingCommunity->name); ?></h2>
                    <button 
                ...
                <!-- Modal Body -->
                <div class="p-6 space-y-6 overflow-y-auto">
                    <?php if (isset($component)) { $__componentOriginala282d45d73373c3c563f1aba1a9a3e9e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala282d45d73373c3c563f1aba1a9a3e9e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.community-assessment-summary','data' => ['summary' => $viewingCommunity->assessmentSummary]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('community-assessment-summary'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['summary' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($viewingCommunity->assessmentSummary)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala282d45d73373c3c563f1aba1a9a3e9e)): ?>
<?php $attributes = $__attributesOriginala282d45d73373c3c563f1aba1a9a3e9e; ?>
<?php unset($__attributesOriginala282d45d73373c3c563f1aba1a9a3e9e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala282d45d73373c3c563f1aba1a9a3e9e)): ?>
<?php $component = $__componentOriginala282d45d73373c3c563f1aba1a9a3e9e; ?>
<?php unset($__componentOriginala282d45d73373c3c563f1aba1a9a3e9e); ?>
<?php endif; ?>
                </div>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\Users\Nikko\Desktop\CAPSTONE\SmartCEMES_FINAL\resources\views/livewire/manage-communities.blade.php ENDPATH**/ ?>