<div class="min-h-screen bg-gradient-to-br from-white to-gray-50 px-8 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8 animate-slide-up">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition duration-300 transform hover:scale-105 hover:-translate-y-1">
            ...
            <p class="text-3xl font-bold text-gray-900"><?php echo e($totalPrograms); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition duration-300 transform hover:scale-105 hover:-translate-y-1">
            ...
            <p class="text-3xl font-bold text-green-600"><?php echo e($activePrograms); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition duration-300 transform hover:scale-105 hover:-translate-y-1">
            ...
            <p class="text-3xl font-bold text-amber-600"><?php echo e($planningPrograms); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition duration-300 transform hover:scale-105 hover:-translate-y-1">
            ...
            <p class="text-3xl font-bold text-purple-600"><?php echo e($completedPrograms); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition duration-300 transform hover:scale-105 hover:-translate-y-1">
            ...
            <p class="text-3xl font-bold text-indigo-600"><?php echo e($totalCommunities); ?></p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 animate-slide-up" style="animation-delay: 0.3s">
            ...
            <div class="space-y-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $communityParticipation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $community): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div 
                        ...
                        style="animation: slideInRight 0.5s ease-out <?php echo e(($index * 0.1)); ?>s both"
                    >
                        <div class="flex-1">
                            <p class="text-sm font-semibold text-gray-900"><?php echo e($community['name']); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($community['programs']); ?> programs</p>
                        </div>
                        <span class="bg-blue-100 text-blue-800 text-xs font-bold px-3 py-1 rounded-full">
                            <?php echo e($community['programs']); ?>
        ...
        <div class="space-y-4 animate-slide-up" style="animation-delay: 0.5s">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-bold text-gray-900"><?php echo e($activePrograms); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-bold text-gray-900"><?php echo e($planningPrograms); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-bold text-gray-900"><?php echo e($completedPrograms); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-bold text-gray-900"><?php echo e($totalPrograms - $activePrograms - $planningPrograms - $completedPrograms); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-lg shadow-md p-6 border border-indigo-100">
                ...
                <div class="space-y-2 text-sm">
                    <p class="flex justify-between"><span class="text-gray-600">Avg per month:</span> <span class="font-bold text-gray-900"><?php echo e(round($totalPrograms / 12, 1)); ?></span></p>
                    <p class="flex justify-between"><span class="text-gray-600">Completion rate:</span> <span class="font-bold text-gray-900"><?php echo e($totalPrograms > 0 ? round(($completedPrograms / $totalPrograms) * 100, 1) : 0); ?>%</span></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentPrograms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr class="hover:bg-blue-50 transition duration-150 hover:shadow-sm cursor-pointer">
                            <td class="px-6 py-4">
                                <p class="font-semibold text-gray-900"><?php echo e(\Illuminate\Support\Str::limit($program['title'], 30)); ?></p>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center justify-center w-8 h-8 bg-blue-100 text-blue-800 text-xs font-bold rounded-full">
                                    <?php echo e($program['communities_count']); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600">
                                <?php echo e($program['created_at']); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (statusCtx) {
            new Chart(statusCtx, {
                type: 'doughnut',
                data: <?php echo json_encode($programStatusData, 15, 512) ?>,
                options: {
                    responsive: true,
        ...
        if (trendCtx) {
            new Chart(trendCtx, {
                type: 'line',
                data: <?php echo json_encode($monthlyTrendData, 15, 512) ?>,
                options: {
                    responsive: true,
                    maintainAspectRatio: false,
                    plugins: {
...
<?php /**PATH C:\Users\Nikko\Desktop\CAPSTONE\SmartCEMES_FINAL\resources\views/livewire/extension-director-dashboard.blade.php ENDPATH**/ ?>