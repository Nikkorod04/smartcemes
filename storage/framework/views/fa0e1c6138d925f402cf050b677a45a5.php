<?php use \App\Models\Beneficiary; ?>

<div class="min-h-screen bg-gradient-to-br from-white to-gray-50 px-8 py-6">
    <div class="w-full">
        <!-- PROGRAMS LIST VIEW -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$selectedProgramId): ?>
            <div class="space-y-3">
                <!-- Search Bar -->
                <div class="mb-6">
                    <input 
                            ...
                            <div class="p-6">
                                <div class="flex items-start justify-between mb-3">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 mt-1"><?php echo e(Str::limit($program->description, 80)); ?></p>
                                    </div>
                                    <span class="inline-block px-3 py-1 rounded-full text-xs font-medium <?php echo e($program->status === 'active' ? 'bg-green-100 text-green-800' :
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-2xl font-bold text-blue-600">
                                                <?php echo e(\App\Models\Beneficiary::whereIn('id', function($q) use($program) { $q->select('beneficiary_id')->from('beneficiary_program')->where('program_id', $program->id); })->count()); ?>

                                            </p>
                                            <p class="text-sm text-gray-600">Beneficiaries</p>
                                        </div>
                                        <button type="button" wire:click="selectProgram(<?php echo e($program->id); ?>)" class="px-4 py-2 bg-blue-900 hover:bg-blue-800 text-white hover:text-yellow-400 rounded-lg font-medium text-sm transition">
                                            Manage
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="space-y-4">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900"><?php echo e($program->title); ?></h2>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900 mt-1"><?php echo e(ucfirst($program->status)); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600 text-sm">Total Beneficiaries</p>
                            <p class="text-lg font-bold text-blue-600 mt-1"><?php echo e($programBeneficiaries->count()); ?></p>
                        </div>
                        <div>
                            <p class="text-gray-600 text-sm">Target</p>
                            <p class="text-lg font-bold text-gray-900 mt-1"><?php echo e($program->target_beneficiaries ?? '-'); ?></p>
                        </div>
                        <div>
                            ...
                            ?>
                            <p class="text-lg font-bold text-green-600 mt-1"><?php echo e($progress); ?>%</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $programBeneficiaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $beneficiary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($beneficiary->full_name); ?></td>
                                        <td class="px-6 py-4 text-gray-600">
                                            <div class="text-xs"><?php echo e($beneficiary->email ?? '-'); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e($beneficiary->phone ?? '-'); ?></div>
                                        </td>
                                        <td class="px-6 py-4">
                                            <span class="inline-block px-2 py-1 bg-blue-50 text-blue-700 rounded text-xs font-semibold">
                                                <?php echo e(ucfirst($beneficiary->beneficiary_category ?? 'N/A')); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4">
                                            <span class="inline-block px-3 py-1 rounded-full text-xs font-medium <?php echo e($beneficiary->status === 'active' ? 'bg-green-100 text-green-800' :
                                                ($beneficiary->status === 'inactive' ? 'bg-gray-100 text-gray-800' :
                                                ($beneficiary->status === 'graduated' ? 'bg-blue-100 text-blue-800' :
                                                'bg-red-100 text-red-800'))); ?>">
                                                <?php echo e(ucfirst($beneficiary->status)); ?>
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex gap-2 justify-end">
                                                <button 
                                                    wire:click="editBeneficiaryInProgram(<?php echo e($beneficiary->id); ?>)"
                                                ...
                                                <button 
                                                    wire:click="removeBeneficiaryFromProgram(<?php echo e($beneficiary->id); ?>)"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showAssignModal && $selectedProgramId): ?>
        <div class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-auto">
            <div class="bg-white rounded-lg shadow-2xl max-w-2xl w-full my-8">
                ...
                <div class="bg-gradient-to-r from-blue-900 to-blue-800 text-white px-6 py-5 flex justify-between items-center border-b-4 border-yellow-400">
                    <h2 class="text-xl font-bold">Add Beneficiaries to <?php echo e($program->title ?? 'Program'); ?></h2>
                    <button 
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="space-y-2 max-h-96 overflow-y-auto">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $availableBeneficiaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $beneficiary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <label class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer transition">
                                <input 
                                    ...
                                    value="<?php echo e($beneficiary->id); ?>"
                                    class="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                                />
                                <div class="ml-3 flex-1">
                                    <p class="font-medium text-gray-900"><?php echo e($beneficiary->full_name); ?></p>
                                </div>
                            </label>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    ...
                    <!-- Selected Count -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($selectedBeneficiaries)): ?>
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                            <p class="text-sm text-blue-800"><strong><?php echo e(count($selectedBeneficiaries)); ?></strong> beneficiary(ies) selected</p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showAddBeneficiaryModal && $selectedProgramId): ?>
        <div class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-auto">
            <div class="bg-white rounded-lg shadow-2xl max-w-2xl w-full my-8">
                <!-- Modal Header -->
                <div class="bg-gradient-to-r from-blue-900 to-blue-800 text-white px-6 py-5 flex justify-between items-center border-b-4 border-yellow-400">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showEditBeneficiaryModal && $editingBeneficiaryId): ?>
        <div class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-auto">
            <div class="bg-white rounded-lg shadow-2xl max-w-2xl w-full my-8">
                <!-- Modal Header -->
                <div class="bg-gradient-to-r from-blue-900 to-blue-800 text-white px-6 py-5 flex justify-between items-center border-b-4 border-yellow-400">
...
<?php /**PATH C:\Users\Nikko\Desktop\CAPSTONE\SmartCEMES_FINAL\resources\views/livewire/manage-beneficiaries.blade.php ENDPATH**/ ?>